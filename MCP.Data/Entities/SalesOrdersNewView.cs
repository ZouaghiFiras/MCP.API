...
{
    public class SalesOrdersNewView
    {
        ...
        public bool HasCreditPurchaseInvoiceWaitingForApproval { get; set; }

        public bool HasDebtor { get; set; }

        public bool HasReopenedAssistancePlan { get; set; }

        public bool HasReopenedWorkingOrderLine { get; set; }

        public bool HasReopenedDossier { get; set; }

        public bool HasPendingAuthorizationDossier { get; set; }
        ...
        public string SalesOrdeType { get; set; } = null!;

        public bool HasMainAuthorize { get; set; }

        public bool? IsSelectable { get; set; }

        public string NonSelectableReason { get; set; } = null!;
    }
}