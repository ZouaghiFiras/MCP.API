...
{
    public class PurchaseOrdersWithPurchaseInvoicesView
    {
        ...
        public decimal? PurchaseOrderLineRemainingAmount { get; set; }

        public bool PurchaseInvoiceToOrderMappingInactive { get; set; }
