...
{
    public class AssistanceDossiersView
    {
        ...
        public bool? PetsInvolved { get; set; }
        ...
        public bool? SecurityVehicleRequested { get; set; }

        public string? CaseNumberAlarmCenter { get; set; }

        public bool? IsDuplicate { get; set; }

        public Guid? OriginalAssistanceDossierId { get; set; }
        ...
        public string IncidentLocationTypeName { get; set; } = null!;
