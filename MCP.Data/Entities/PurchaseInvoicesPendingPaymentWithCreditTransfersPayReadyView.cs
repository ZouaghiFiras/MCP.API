...
{
    public class PurchaseInvoicesPendingPaymentWithCreditTransfersPayReadyView
    {
        ...
        public string? CreditTransferStatusCode { get; set; }

        public string? CreditTransferStatusName { get; set; }

        public DateTime? CreditTransferStatusCreatedDate { get; set; }
