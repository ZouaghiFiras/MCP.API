...
{
    public class AuthorizationRoleInheritanceView
    {
        public Guid? Id { get; set; }

        public string AuthorizationGroupRoleId { get; set; } = null!;

        public string AuthorizationInheritsRoleId { get; set; } = null!;
