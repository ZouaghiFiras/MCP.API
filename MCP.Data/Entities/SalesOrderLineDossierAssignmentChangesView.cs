...
{
    public class SalesOrderLineDossierAssignmentChangesView
    {
        ...
        public Guid? DossierAssignmentProductId { get; set; }
        ...
        public int? WorkingOrderLineCostCoverageInactive { get; set; }
        ...
        public decimal? TimeSheetQuantity { get; set; }
    }
}